...
/**
 * `perPageOptions` se har jagah apni pasand ke options diye ja sakte hain --
 * Contacts ki bari table par 25+ theek hai, magar dashboard ke chhote card par
 * 10 se shuru karna behtar lagta hai.
 */
const Pagination = ({
  currentPage,
  totalPages,
